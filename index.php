...
<div id="top">
    ...
    <div id="text">
        <h1>Тепловизор "Оберег" </br>на страже вашего имущества.</h1>
        ...
        <h1 id="sale">12000 рублей</h1>
        <form id="Form1" enctype="multipart/form-data" action="pre-order.php" method="post" name="pre_order">
            <input required id="email" type="email" placeholder=" e-mail" value="" name="email"></input>
            <input id="send" class="send" type="submit" value="Предзаказ" style="cursor:pointer;" name="send"></input>
        </form>
    </div>
</div>
<div id="room">
